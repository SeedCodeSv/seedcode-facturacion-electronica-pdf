...
exports.generateSvfe01_2 = void 0;
 ...
 * @returns {unknown}
 */
var generateSvfe01_2 = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
                    ...
                    didDrawCell: function (data) {
                        ...
                        if (data.section === "head") {
                            if (data.column.index === 0) {
                                ...
                                doc.setFontSize(9);
                                doc.text("Nombre entrega: ".concat(extension ? (_a = extension.nombEntrega) !== null && _a !== void 0 ? _a : "" : ""), data.cell.x + 10, data.cell.y + 179);
                                doc.text("Documento entrega: ".concat(extension ? (_b = extension.docuEntrega) !== null && _b !== void 0 ? _b : "" : ""), data.cell.x + 10, data.cell.y + 195);
                                doc.text("Nombre recibe: ".concat(extension ? (_c = extension.nombRecibe) !== null && _c !== void 0 ? _c : "" : ""), data.cell.x + 450, data.cell.y + 179);
                                doc.text("Documento recibe: ".concat(extension ? (_d = extension.docuRecibe) !== null && _d !== void 0 ? _d : "" : ""), data.cell.x + 450, data.cell.y + 195);
                            ...
                            if (data.column.index === 1) {
                                ...
                                if (resumen.tributos && resumen.tributos.length > 0) {
                                    tourism =
                                        ((_e = resumen.tributos.find(function (tributo) { return tributo.codigo === "59"; })) === null || _e === void 0 ? void 0 : _e.valor) || 0;
                                }
                                var valorem = 0;
                                if (resumen.tributos && resumen.tributos.length > 0) {
                                    valorem =
                                        ((_f = resumen.tributos.find(function (tributo) { return tributo.codigo === "C5"; })) === null || _f === void 0 ? void 0 : _f.valor) || 0;
                                }
                                var propina = (_h = (_g = svfe01.cuerpoDocumento.find(function (cuerpo) { return cuerpo.descripcion === "PROPINA"; })) === null || _g === void 0 ? void 0 : _g.noGravado) !== null && _h !== void 0 ? _h : 0;
                                ...
                                textYTotals += 12;
                                doc.text((0, utils_1.formatCurrency)(resumen.totalIva), data.cell.x + 230, textYTotals);
                                textYTotals += 12;
                                doc.text((0, utils_1.formatCurrency)(resumen.subTotalVentas), data.cell.x + 230, textYTotals);
                                textYTotals += 12;
                                doc.text((0, utils_1.formatCurrency)((_j = resumen.ivaPerci1) !== null && _j !== void 0 ? _j : 0), data.cell.x + 230, textYTotals);
                                textYTotals += 12;
                                doc.text((0, utils_1.formatCurrency)((_k = resumen.ivaRete1) !== null && _k !== void 0 ? _k : 0), data.cell.x + 230, textYTotals);
                                textYTotals += 12;
                                        ...
                                        didDrawCell: function (data) {
                                            ...
                                            if (data.section === "head") {
                                                if (data.column.index === 0) {
                                                    ...
                                                    doc.text(svfe01.receptor.tipoDocumento
                                                        ? (0, utils_2.formatNameTypeDocument)(svfe01.receptor.tipoDocumento)
                                                        : "-", paddingX + 100, lastY_3);
                                                    lastY_3 += 30;
                                                    doc.text(doc.splitTextToSize("Numero de documento: ", 100), paddingX, lastY_3 - 5);
                                                    doc.text((_a = svfe01.receptor.numDocumento) !== null && _a !== void 0 ? _a : "-", paddingX + 100, lastY_3);
                                                    lastY_3 += 35;
                                                    ...
                                                    doc.text((_b = svfe01.receptor.nrc) !== null && _b !== void 0 ? _b : "-", paddingX + 100, lastY_3);
                                                    doc.setFillColor(fillColor2);
...
exports.generateSvfe01_2 = generateSvfe01_2;
