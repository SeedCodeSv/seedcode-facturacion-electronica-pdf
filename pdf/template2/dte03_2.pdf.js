...
exports.generateSvfe03_2 = void 0;
 ...
 * @returns {unknown}
 */
var generateSvfe03_2 = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var doc, marginX, marginY, tableWidth, tableHeight, radius, lastY, data, result, icons, PHONE, INSTAGRAM, FACEBOOK, TIKTOK, WHATSAPP, resumen, extension, pageCounter, _loop_1, i;
    var _c, _d, _e;
    var borderColor = _b.borderColor, fillColor = _b.fillColor, fillColor2 = _b.fillColor2, darkTextColor = _b.darkTextColor, lightTextColor = _b.lightTextColor, tertiaryColor = _b.tertiaryColor, svfe01 = _b.svfe01, logoWidth = _b.logoWidth, logoHeight = _b.logoHeight, socialMedia = _b.socialMedia, _f = _b.logo, logo = _f === void 0 ? "" : _f, _g = _b.watermark, watermark = _g === void 0 ? "" : _g, _h = _b.selloInvalidacion, selloInvalidacion = _h === void 0 ? "" : _h;
    return __generator(this, function (_j) {
        switch (_j.label) {
            case 0:
                ...
                data = svfe01.cuerpoDocumento
                    .filter(function (item) { return item.descripcion !== "PROPINA"; })
                    .map(function (item) { return [
                    item.cantidad,
                    item.descripcion,
                    (0, utils_1.formatCurrency)(+item.precioUni),
                    (0, utils_1.formatCurrency)(+item.montoDescu),
                    (0, utils_1.formatCurrency)(+item.ventaNoSuj),
                    (0, utils_1.formatCurrency)(+item.ventaExenta),
                    (0, utils_1.formatCurrency)(+item.ventaGravada),
                ]; });
            ...
            case 5:
                WHATSAPP = _j.sent();
                resumen = svfe01.resumen, extension = svfe01.extension;
                (0, jspdf_autotable_1.default)(doc, {
                    head: [["", ""]],
                    startY: 800,
                    theme: "plain",
                    ...
                    didDrawCell: function (data) {
                        ...
                        if (data.section === "head") {
                            if (data.column.index === 0) {
                                ...
                                var observations = doc.splitTextToSize("Notas: ".concat(extension ? extension.observaciones : ""), 225);
                                doc.text(observations, data.cell.x + 10, data.cell.y + 20);
                                doc.text("Cantidad en letras: ", data.cell.x + 10, data.cell.y + 125);
                                doc.roundedRect(data.cell.x + 100, data.cell.y + 110, 350, 30, 5, 5, "S");
                                doc.text(resumen.totalLetras, data.cell.x + 110, data.cell.y + 127);
                                doc.roundedRect(data.cell.x, data.cell.y + 160, 760, 50, 15, 15, "S");
                                doc.setFontSize(9);
                                doc.text("Nombre entrega: ".concat(extension ? extension.nombEntrega : ""), data.cell.x + 10, data.cell.y + 179);
                                doc.text("Documento entrega: ".concat(extension ? extension.docuEntrega : ""), data.cell.x + 10, data.cell.y + 195);
                                doc.text("Nombre recibe: ".concat(extension ? extension.nombRecibe : ""), data.cell.x + 450, data.cell.y + 179);
                                doc.text("Documento recibe: ".concat(extension ? extension.docuRecibe : ""), data.cell.x + 450, data.cell.y + 195);
                                doc.setTextColor(tertiaryColor);
                                doc.addImage(INSTAGRAM, "PNG", data.cell.x + 10, data.cell.y + 218, 14, 14);
                                doc.text(socialMedia.instagram, data.cell.x + 30, data.cell.y + 228);
                                doc.addImage(FACEBOOK, "PNG", data.cell.x + 159.2, data.cell.y + 218, 14, 14);
                                doc.text(socialMedia.facebook, data.cell.x + 180, data.cell.y + 228);
                                doc.addImage(TIKTOK, "PNG", data.cell.x + 318.4, data.cell.y + 218, 14, 14);
                                doc.text(socialMedia.tiktok, data.cell.x + 339, data.cell.y + 228);
                                doc.addImage(WHATSAPP, "PNG", data.cell.x + 474.6, data.cell.y + 218, 14, 14);
                                doc.text(socialMedia.whatsapp, data.cell.x + 495, data.cell.y + 228);
                                doc.addImage(PHONE, "PNG", data.cell.x + 633.8, data.cell.y + 218, 14, 14);
                            ...
                            if (data.column.index === 1) {
                                ...
                                doc.setFontSize(8);
                                doc.setTextColor(darkTextColor);
                                doc.text("Suma total de operación:", data.cell.x + 215, data.cell.y + 10, {
                                    align: "right",
                                });
                                var textY = data.cell.y + 22;
                                doc.text("Turismo 5%:", data.cell.x + 215, textY, {
                                    align: "right",
                                });
                                textY += 12;
                                doc.text("Impuesto al Valor Agregado 13%:", data.cell.x + 215, textY, {
                                    align: "right",
                                });
                                textY += 12;
                                ...
                                if (resumen.tributos && resumen.tributos.length > 0) {
                                    tourism =
                                        ((_a = resumen.tributos.find(function (tributo) { return tributo.codigo === "59"; })) === null || _a === void 0 ? void 0 : _a.valor) || 0;
                                }
                                var valorem = 0;
                                if (resumen.tributos && resumen.tributos.length > 0) {
                                    valorem =
                                        ((_b = resumen.tributos.find(function (tributo) { return tributo.codigo === "C5"; })) === null || _b === void 0 ? void 0 : _b.valor) || 0;
                                }
                                var propina = (_d = (_c = svfe01.cuerpoDocumento.find(function (cuerpo) { return cuerpo.descripcion === "PROPINA"; })) === null || _c === void 0 ? void 0 : _c.noGravado) !== null && _d !== void 0 ? _d : 0;
                                var totalIva = resumen.tributos && resumen.tributos.length > 0
                                    ? ((_e = resumen.tributos.find(function (tributo) { return tributo.codigo === "20"; })) === null || _e === void 0 ? void 0 : _e.valor) || 0
                                    : 0;
                                var noAfectos = resumen.totalExenta + resumen.totalNoSuj;
                                doc.text((0, utils_1.formatCurrency)(resumen.subTotal), data.cell.x + 230, data.cell.y + 10);
                                var textYTotals = data.cell.y + 22;
                                doc.text((0, utils_1.formatCurrency)(tourism), data.cell.x + 230, textYTotals);
                                textYTotals += 12;
                                doc.text((0, utils_1.formatCurrency)(totalIva), data.cell.x + 230, textYTotals);
                                textYTotals += 12;
                                doc.text((0, utils_1.formatCurrency)(resumen.subTotalVentas), data.cell.x + 230, textYTotals);
                                textYTotals += 12;
                                doc.text((0, utils_1.formatCurrency)((_f = resumen.ivaPerci1) !== null && _f !== void 0 ? _f : 0), data.cell.x + 230, textYTotals);
                                textYTotals += 12;
                                doc.text((0, utils_1.formatCurrency)((_g = resumen.ivaRete1) !== null && _g !== void 0 ? _g : 0), data.cell.x + 230, textYTotals);
                                textYTotals += 12;
                                doc.text((0, utils_1.formatCurrency)(resumen.reteRenta), data.cell.x + 230, textYTotals);
                                textYTotals += 12;
                                doc.text((0, utils_1.formatCurrency)(resumen.montoTotalOperacion), data.cell.x + 230, textYTotals);
                                textYTotals += 12;
                                doc.text((0, utils_1.formatCurrency)(valorem), data.cell.x + 230, textYTotals);
                                textYTotals += 12;
                                doc.text((0, utils_1.formatCurrency)(propina), data.cell.x + 230, textYTotals);
                                textYTotals += 12;
                                doc.text((0, utils_1.formatCurrency)(noAfectos), data.cell.x + 230, textYTotals);
                                textYTotals += 12;
                                doc.text((0, utils_1.formatCurrency)(resumen.totalPagar), data.cell.x + 230, textYTotals);
                            }
                        }
                    },
                });
                ...
                _loop_1 = function (i) {
                    var isFirstPage, isLastPage, hasMultiplePages, adjustedImage, lineHeight, pageWidth, pageHeight, rectWidth, rectHeight, centerX, offsetY, QR, _k, imageBase64, width, height, payCondition_1;
                        ...
                        switch (_l.label) {
                            ...
                            case 2:
                                ...
                                if (isLastPage) {
                                    ...
                                    doc.roundedRect(25, doc.internal.pageSize.height - 298, 769, 20, 20, 20, "F");
                                    doc.roundedRect(25, doc.internal.pageSize.height - 298, 769, 10, 2, 2, "F");
                                    doc.setFontSize(11);
                                    ...
                                    doc.line(515, doc.internal.pageSize.height - 298, 515, doc.internal.pageSize.height - 278);
                                    doc.setFontSize(10);
                                    doc.text((0, utils_1.formatCurrency)(resumen.totalDescu), 550, doc.internal.pageSize.height - 285, {
                                        align: "center",
                                    });
                                    doc.line(585, doc.internal.pageSize.height - 298, 585, doc.internal.pageSize.height - 278);
                                    doc.text((0, utils_1.formatCurrency)(resumen.totalNoSuj), 620, doc.internal.pageSize.height - 285, {
                                        align: "center",
                                    });
                                    doc.line(655, doc.internal.pageSize.height - 298, 655, doc.internal.pageSize.height - 278);
                                    doc.text((0, utils_1.formatCurrency)(resumen.totalExenta), 690, doc.internal.pageSize.height - 285, {
                                        align: "center",
                                    });
                                    doc.line(725, doc.internal.pageSize.height - 298, 725, doc.internal.pageSize.height - 278);
                                    doc.text((0, utils_1.formatCurrency)(resumen.totalGravada), 760, doc.internal.pageSize.height - 285, {
                                        align: "center",
                                    });
                                }
                                return [4 /*yield*/, (0, utils_1.generateQRWithColor)(svfe01, darkTextColor)];
                            case 3:
                                QR = _l.sent();
                                return [4 /*yield*/, (0, utils_1.adjustImage)(logo, logoWidth, logoHeight)];
                            case 4:
                                _k = _l.sent(), imageBase64 = _k.imageBase64, width = _k.width, height = _k.height;
                                (0, jspdf_autotable_1.default)(doc, {
                                    head: [["", ""]],
                                    showHead: true,
                                    startY: marginY + 3,
                                    ...
                                    didDrawCell: function (data) {
                                        ...
                                        if (data.section === "head") {
                                            if (data.column.index === 0) {
                                                ...
                                                var lastY_1 = 110;
                                                doc.setFontSize(13);
                                                doc.text(svfe01.emisor.nombre, data.cell.x + 10, lastY_1);
                                                lastY_1 += 15;
                                                doc.setFontSize(10);
                                                doc.setTextColor(tertiaryColor);
                                                doc.text("N.I.T: ", data.cell.x + 10, lastY_1);
                                                doc.setFont("Nunito", "normal");
                                                doc.text(svfe01.emisor.nit, data.cell.x + 40, lastY_1);
                                                doc.setFont("Nunito", "bold");
                                                doc.text("N.R.C: ", data.cell.x + 150, lastY_1);
                                                doc.setFont("Nunito", "normal");
                                                doc.text(svfe01.emisor.nrc, data.cell.x + 180, lastY_1);
                                                doc.setTextColor(darkTextColor);
                                                doc.setFont("Nunito", "bold");
                                                lastY_1 += 15;
                                                doc.setFontSize(8);
                                                doc.setFont("Nunito", "normal");
                                                var address = doc.splitTextToSize((0, utils_1.formatAddress)(svfe01.emisor.direccion.departamento, svfe01.emisor.direccion.municipio) +
                                                    " " +
                                                    svfe01.emisor.direccion.complemento, 380);
                                                var textH = (0, utils_1.getHeightText)(doc, address);
                                                doc.text(address, data.cell.x + 10, lastY_1);
                                                lastY_1 += textH + 2;
                                                doc.text(svfe01.emisor.correo, data.cell.x + 10, lastY_1);
                                            ...
                                            if (data.column.index === 1) {
                                                ...
                                                doc.setFont("Nunito", "normal");
                                                doc.setFontSize(8);
                                                doc.text((0, utils_2.formatDocumentType)(svfe01.identificacion.tipoDte), data.cell.x + 200, data.cell.y + 32, { align: "center" });
                                                ...
                                                doc.setFontSize(7.5);
                                                doc.text(svfe01.identificacion.codigoGeneracion, data.cell.x + 185, lastY_2 + 1);
                                                lastY_2 += 21;
                                                doc.setFontSize(8);
                                                ...
                                                doc.setFontSize(7.5);
                                                doc.text(svfe01.identificacion.numeroControl, data.cell.x + 200, lastY_2 + 1);
                                                lastY_2 += 21;
                                                doc.setFontSize(8);
                                                ...
                                                doc.setFontSize(7.5);
                                                doc.text((_a = svfe01.respuestaMH.selloRecibido) !== null && _a !== void 0 ? _a : "", data.cell.x + 170, lastY_2 + 1);
                                                lastY_2 += 18;
                                                doc.setFontSize(7);
                                                doc.setTextColor(darkTextColor);
                                                ...
                                                doc.text("".concat(svfe01.identificacion.fecEmi, " - ").concat(svfe01.identificacion.horEmi), data.cell.x + 293, lastY_2 + 8);
                                                doc.setLineWidth(1);
                                                ...
                                                doc.text(svfe01.identificacion.tipoMoneda, data.cell.x + 225, lastY_2 + 21);
                                            }
                                        }
                                    },
                                });
                                if (i === 1) {
                                    lastY = doc.lastAutoTable.finalY;
                                    payCondition_1 = (_e = resumen.pagos[0].codigo) !== null && _e !== void 0 ? _e : "01";
                                    (0, jspdf_autotable_1.default)(doc, {
                                        head: [[""]],
                                        showHead: true,
                                        startY: lastY + 110,
                                        ...
                                        didDrawCell: function (data) {
                                            if (data.section === "head") {
                                                if (data.column.index === 0) {
                                                    ...
                                                    doc.text(svfe01.receptor.nombre, paddingX + 100, lastY_3 + 3);
                                                    lastY_3 += 30;
                                                    var actEco = doc.splitTextToSize("Actividad Economica: ", 100);
                                                    doc.text(svfe01.receptor.descActividad, paddingX + 100, lastY_3);
                                                    doc.text(actEco, paddingX, lastY_3);
                                                    lastY_3 += 40;
                                                    doc.text("Dirección: ", paddingX, lastY_3);
                                                    var address = doc.splitTextToSize(doc.splitTextToSize(svfe01.receptor.direccion
                                                        ? (0, utils_1.formatAddress)(svfe01.receptor.direccion.departamento, svfe01.receptor.direccion.municipio) +
                                                            ", " +
                                                            svfe01.receptor.direccion.complemento
                                                        : "", 600), 700);
                                                    doc.text(address, paddingX + 100, lastY_3);
                                                    lastY_3 += 40;
                                                    doc.text("NIT: ", paddingX, lastY_3);
                                                    doc.text(svfe01.receptor.nit, paddingX + 100, lastY_3);
                                                    lastY_3 += 25;
                                                    doc.text("NRC: ", paddingX, lastY_3);
                                                    doc.text(svfe01.receptor.nrc, paddingX + 100, lastY_3);
                                                    lastY_3 += 25;
                                                    doc.text("Correo: ", paddingX, lastY_3);
                                                    doc.text(svfe01.receptor.correo, paddingX + 100, lastY_3);
                                                    lastY_3 += 25;
                                                    var nomCom = doc.splitTextToSize("Nombre comercial: ", 80);
                                                    doc.text(nomCom, paddingX, lastY_3);
                                                    doc.text(svfe01.receptor.nombreComercial, paddingX + 100, lastY_3);
                                                    doc.setFillColor(fillColor2);
                                                    doc.rect(data.cell.x + 60, data.cell.y + 243, 130, 17, "F");
                                                    doc.setTextColor("#ffffff");
                                                    doc.text("Condiciones de pago: ", data.cell.x + 70, data.cell.y + 255);
                                                    doc.setTextColor(darkTextColor);
                                                    doc.text(payCondition_1 === "01" ? "Contado" : "Credito", data.cell.x + 200, data.cell.y + 255);
                                                }
                                            }
                                        },
                                    });
...
exports.generateSvfe03_2 = generateSvfe03_2;
